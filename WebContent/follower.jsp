					...
					<div class="following_profile">
						...
						<div class="following_followingBtn">
							...
							<c:if test="${follower.tFollowCode == null}">
								<input type="button" id="${follower.vFollowUserCode}"
									class="friendsList_followBtn" value="+팔로우" />
							</c:if>
							<c:if test="${follower.tFollowCode != null}">
								<input type="button" id="${follower.tFollowCode}"
									class="following_followBtn" value="✔팔로잉" />
							</c:if>
						</div>
					</div>
				</c:forEach>
