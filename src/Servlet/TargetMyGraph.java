...
/**
 * Servlet implementation class TargetMyGraph
 */
public class TargetMyGraph extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
		...
		RequestDispatcher rd = request.getRequestDispatcher("targetGraph.jsp");
